    ...
    public function update(Request $request): RedirectResponse
    {
      ...
      if ($user && $request->current_password !== $user->password) {
        ...
        if ($blind) {
            ...
            return redirect()->route('blinds.index')->with('success', 'تم تحديث كلمة المرور بنجاح.'); // توجيه لصفحة الكفيف
        }
        ...
        if ($volunteer) {
            ...
            return redirect()->route('volunteers.index')->with('success', 'تم تحديث كلمة المرور بنجاح.'); // توجيه لصفحة المتطوع
        }
    }
}
