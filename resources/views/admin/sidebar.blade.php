...
<style>
    ...
    .rotate-180 {
        transform: rotate(180deg); /* دوران السهم بزاوية 180 درجة */
          ...
          <li>
            <a class="flex items-center flex-shrink-0 h-14 px-3 mt-80 text-sm font-medium rounded hover:bg-customGreen hover:text-white {{ Request::is('logout') ? 'active' : 'bg-white text-customGreen' }}" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
