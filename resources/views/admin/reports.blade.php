            ...
            <tr class="{{ $loop->index % 2 == 0 ? 'bg-white' : 'bg-gray-100' }}"> <!-- استخدام colors مختلفة -->
                    ...
                    <td class="py-2 px-4 border-b">
                        <div class="flex items-center justify-between space-x-1">
                            ...
                            <form action="{{ route('volunteers.deactivate', $report->volunteer_id) }}" method="POST" style="display:inline;">
                                @csrf
                            ...
                            <form action="{{ route('volunteers.reject.report', $report->volunteer_id) }}" method="POST" style="display:inline;">
                                @csrf
