...
<div class="bg-gray-100 flex items-center justify-center min-h-screen ">
    <div class="bg-white py-10 rounded-xl shadow-lg w-full max-w-5xl px-6 lg:px-20">
        ...
        <div class="mb-4">
                ...
                <input type="text" id="title" title="عنوان الطلب" name="title" tabindex="0" class="navigable w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-customGreen" placeholder="ادخل عنوان الطلب">
                @error('title')
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4" title="تفاصيل الطلب" tabindex="0" class="navigable w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-customGreen" placeholder="اكتب تفاصيل الطلب" style="resize: none;"></textarea>
                @error('description')
                <p tabindex="0" class="navigable " style="color: red">{{ $message }}</p>
                @enderror
            </div>
