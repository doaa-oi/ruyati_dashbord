    ...
    <div class="bg-white py-10 rounded-xl shadow-lg w-full max-w-5xl px-6 lg:px-20">
        ...
        <form>
            <div class="mb-4">
                ...
                <input type="text" id="title" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-customGreen" placeholder="ادخل عنوان الطلب">
            </div>

            <div class="mb-4">
                <label for="details" class="block mb-2 text-lg font-bold text-gray-700 text-right">تفاصيل الطلب</label>
                <textarea id="details" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-customGreen" placeholder="اكتب تفاصيل الطلب" style="resize: none;"></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center mt-2">
                    ...
                    <input type="text" id="locationField" name="location" class="text-center border border-gray-300 text-gray-900 h-11 rounded-lg text-sm  w-full focus:outline-none focus:ring-2 focus:ring-customGreen mr-8" readonly>
                </div>
            </div>
